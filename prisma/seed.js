...
async function main() {
    ...
    await prisma.equipe.createMany({
        data: [
            {
                nome_equipe: 'Equipe ClubeLivro',
                nome: 'Ana Silva',
                curso: 'Engenharia de Software',
                curso_en: 'Software Engineering',
                funcao: 'Desenvolvedora Backend',
                descricao: 'Responsável pela arquitetura do backend.',
                descricao_en: 'Responsible for backend architecture.',
            ...
            },
            {
                ...
                curso_en: 'Computer Science',
                funcao: 'Desenvolvedor Frontend',
                descricao: 'Especialista em interfaces web responsivas.',
                descricao_en: 'Specialist in responsive web interfaces.',
            ...
            },
            {
                ...
                curso_en: 'Graphic Design',
                funcao: 'Designer UX/UI',
                descricao: 'Criadora de experiências visuais intuitivas.',
                descricao_en: 'Creator of intuitive visual experiences.',
